...
/**
 * Long field type for Elasticsearch.
 * Used for long integer values.
 */
class LongType extends AbstractElasticType
{
    /**
     * Constructor.
     *
     ...
     * @return self
     */
    public function setNullValue(int $nullValue): self
    {
