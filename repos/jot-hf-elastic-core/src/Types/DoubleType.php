...
/**
 * Double field type for Elasticsearch.
 * Used for double-precision 64-bit IEEE 754 floating point numbers.
 */
class DoubleType extends AbstractElasticType
{
    /**
     * Constructor.
     *
     ...
     * @return self
     */
    public function setNullValue(float $nullValue): self
    {
