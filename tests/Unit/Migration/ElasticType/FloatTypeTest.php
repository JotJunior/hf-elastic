...
use Jot\HfElastic\Migration\ElasticType\FloatType;
use Jot\HfElastic\Migration\ElasticType\Type;
use PHPUnit\Framework\TestCase;

/**
 * @covers \Jot\HfElastic\Migration\ElasticType\FloatType
 * @group unit
 * @internal
 */
class FloatTypeTest extends TestCase
{
    ...
    {
        parent::setUp();
        $this->type = new FloatType('float_field');
    }
    ...
    {
        // Act
        $type = new FloatType('float_field');
        $options = $type->getOptions();

        // Assert
        $this->assertEquals(Type::float, $type->getType(), 'Type should be set to float');
        $this->assertEquals('float_field', $type->getName(), 'Field name should match the provided name');
    ...
    {
        // Arrange
        $metaData = ['description' => 'Test float field'];
    ...
    public function testGetOptionsWithMultipleOptionsSet(): void
    {
        ...
        $this->assertTrue($options['store'], 'store option should be set to true');
        $this->assertTrue($options['time_series_dimension'], 'time_series_dimension option should be set to true');
        $this->assertEquals('gauge', $options['time_series_metric'], 'time_series_metric option should be set to the provided value');
    }
}
